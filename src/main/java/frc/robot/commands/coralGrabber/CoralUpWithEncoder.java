...
// public class CoralUpWithEncoder extends Command {
//   private CoralGrabber coralGrabber;
//   private double speed, targetEncoderPosition;
//   private boolean finished;

//   /** Creates a new CoralUp. */
//   public CoralUpWithEncoder(CoralGrabber coralGrabber, double speed, double targetEncoderValue) {
...
//   @Override
//   public void execute() {
//     finished = coralGrabber.upWithEncoder(speed, targetEncoderPosition);
//   }
